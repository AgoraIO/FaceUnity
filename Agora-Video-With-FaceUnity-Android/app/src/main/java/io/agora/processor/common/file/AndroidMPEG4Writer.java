...
public class AndroidMPEG4Writer extends BaseMuxer {
    ...
    /**
     * Constructor
     * @param rtmpConfigInfo
     * @throws Exception
     */
    public AndroidMPEG4Writer(RtmpConfigInfo rtmpConfigInfo) throws Exception {
        super(rtmpConfigInfo.isEnableWriteAudio(), rtmpConfigInfo.isEnableWriteVideo());
        try {
            if (rtmpConfigInfo.getLocalFilePath() != null) {
                mOutputPath = rtmpConfigInfo.getLocalFilePath();
            } else {
