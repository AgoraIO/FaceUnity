...
class IRtcEngineEventHandler {
  ...
  */
  ...
  /**
   * Reports the change of remote video stream info.
   *
   * @param info The current info of the remote video stream.
   */
  virtual void onRemoteVideoStreamInfoUpdated(const RemoteVideoStreamInfo& info) { (void)info; }
